...
network_parameters = {
    ...
    'name': datetime.datetime.now().strftime("%y-%m-%d") + '_synth_kernel3/3layers',
    # 'name': '22-10-17_synth_kernel3/finetuning_realdata',
}
...
data_parameters = {
    ...
    "preprocessing_parameters": {
        ...
        "zscore": '../data/feature_means_kernel3.json', #False, or file_path
    },
