...
network_parameters = {
    ...
    'name': datetime.datetime.now().strftime("%y-%m-%d") + '_synth/3layers/baseline',
    # 'name': '22-10-18_synth/3layers/baseline',
}
...
data_parameters = {
    ...
    "preprocessing_parameters": {
        ...
        "zscore": '../data/feature_means.json', #False or file path
    },
