        ...
        for desired_name in feature_names:
            ...
            if self.subject_id in df.index:
                if matched_name == "Freesurfer_nul":
                    ...
                    if isinstance(feature, list) or isinstance(feature, pd.Series):
                        print('WARNING: Duplicates found in demographics, please check the demographics file and remove duplicate subjects.')
                        return None
                if normalize:
